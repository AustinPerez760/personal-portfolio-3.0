...
export default function Header() {
	...
	return (
		<header className='z-[999] relative'>
			<motion.div
				className='fixed top-0 left-1/2  h-[4.5rem] w-full rounded-none border border-gray-300 border-opacity-40 bg-white bg-opacity-70 shadow-lg shadow-black/[0.003] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full'
						...
						<motion.li
							...
							<Link
								className={clsx(
									...
									{
										'font-bold text-sky-800': activeSection === link.name,
									}
								)}
								href={link.hash}
								onClick={() => {
